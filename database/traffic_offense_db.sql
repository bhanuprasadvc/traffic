...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `getdrivers_list` ()   SELECT * FROM drivers_list$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `getoffense_list` ()   SELECT * FROM offense_list$$
...
(5, 'gnd 982737', 'B K, Pavan Kumar', 1, '2023-01-20 17:25:16', NULL),
(6, 'gnd 768712', 'R, Rakshith Gowda', 1, '2023-01-20 17:25:47', NULL);

--
-- Triggers `drivers_list`
--
DELIMITER $$
CREATE TRIGGER `deletion` AFTER DELETE ON `drivers_list` FOR EACH ROW INSERT INTO trig VALUES(null,OLD.id,"DRIVER DELETED",NOW())
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `insertion` AFTER INSERT ON `drivers_list` FOR EACH ROW INSERT INTO trig VALUES(null,NEW.id,"Driver Inserted",NOW())
$$
DELIMITER ;
DELIMITER $$
CREATE TRIGGER `updation` AFTER UPDATE ON `drivers_list` FOR EACH ROW INSERT INTO trig VALUES(null,NEW.id,'DRIVER UPDATED',now())
$$
DELIMITER ;
...
(5, 'license_id_no', 'gnd 982737', '2023-01-20 17:25:16'),
(5, 'lastname', 'b k', '2023-01-20 17:25:16'),
(5, 'firstname', 'pavan', '2023-01-20 17:25:16'),
(5, 'middlename', 'kumar', '2023-01-20 17:25:16'),
(5, 'dob', '2015-07-15', '2023-01-20 17:25:16'),
(5, 'present_address', 'asa', '2023-01-20 17:25:16'),
(5, 'permanent_address', 'sds', '2023-01-20 17:25:16'),
(5, 'civil_status', 'Married', '2023-01-20 17:25:16'),
(5, 'nationality', 'indian', '2023-01-20 17:25:16'),
(5, 'contact', '9985995588', '2023-01-20 17:25:16'),
(5, 'license_type', 'Student', '2023-01-20 17:25:16'),
(5, 'image_path', '', '2023-01-20 17:25:16'),
(5, 'driver_id', '5', '2023-01-20 17:25:16'),
(6, 'license_id_no', 'gnd 768712', '2023-01-20 17:25:47'),
(6, 'lastname', 'R', '2023-01-20 17:25:47'),
(6, 'firstname', 'Rakshith', '2023-01-20 17:25:47'),
(6, 'middlename', 'Gowda', '2023-01-20 17:25:47'),
(6, 'dob', '2023-01-20', '2023-01-20 17:25:47'),
(6, 'present_address', 'vfd', '2023-01-20 17:25:47'),
(6, 'permanent_address', 'ffdd', '2023-01-20 17:25:47'),
(6, 'civil_status', 'Single', '2023-01-20 17:25:47'),
(6, 'nationality', 'indian', '2023-01-20 17:25:47'),
(6, 'contact', '9907736345', '2023-01-20 17:25:47'),
(6, 'license_type', 'Student', '2023-01-20 17:25:47'),
(6, 'image_path', '', '2023-01-20 17:25:47'),
(6, 'driver_id', '6', '2023-01-20 17:25:47');
...
INSERT INTO `trig` (`tid`, `id`, `action`, `timesamp`) VALUES
(1, 5, 'Driver Inserted', '2023-01-20 17:25:16'),
(2, 6, 'Driver Inserted', '2023-01-20 17:25:47');
